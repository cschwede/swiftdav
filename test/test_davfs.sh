...
# Move container into another container
mv $MOUNTPOINT/$DIRNAME2 $MOUNTPOINT/$DIRNAME/
cmp $FILENAME $MOUNTPOINT/$DIRNAME/$DIRNAME2/$FILENAME2

# Remove everything
rm $FILENAME
rm $MOUNTPOINT/$DIRNAME/$DIRNAME2/$FILENAME2
sleep 1
ls $MOUNTPOINT/$DIRNAME/
rmdir $MOUNTPOINT/$DIRNAME || ls $MOUNTPOINT/$DIRNAME
